...
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <Text style={{ fontSize:20, fontFamily:'Alata-Regular', color:colors.white}} >New Knowledge
Content</Text>
  </View>
...
<View style={{flexDirection:'row', padding:10, paddingLeft:80, top:5 }} >
    <TouchableOpacity onPress={()=>navigation.navigate('HalamanStrategy')}  style={{padding:10, backgroundColor:colors.primary, paddingHorizontal:80, borderRadius:10,}} >
