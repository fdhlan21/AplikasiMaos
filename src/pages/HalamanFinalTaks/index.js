...
<View  style={{flexDirection:'row', backgroundColor:colors.secondary, padding:10,paddingVertical:20, borderBottomLeftRadius:20, borderBottomRightRadius:20, }}>
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <View style={{flexDirection:'row', padding:10,  paddingLeft:35,}}>
  <Text style={{ fontSize:20, fontFamily:'Alata-Regular', color:colors.white}} >Final Task/
Activities
</Text>
  </View>
...
<View style={{flexDirection:'row', padding:10, paddingLeft:80, top:5 }} >
    <TouchableOpacity  onPress={()=>navigation.navigate('HalamanReflection')}   style={{padding:10, backgroundColor:colors.primary, paddingHorizontal:80, borderRadius:10,}} >
...
<View style={{flexDirection:'row', padding:10,}}>
    ...
    <TouchableOpacity onPress={()=>navigation.navigate('HalamanProfile')}  style={{ paddingLeft:55}}  >
