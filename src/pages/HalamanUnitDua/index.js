...
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white}} >Unit 2</Text>
  </View>
</View>
<ScrollView>
 
<View   style={{ flexDirection:'row', padding:10,  paddingLeft:55, bottom:5}}>
    <Image style={{width:252, height:387}}     source={require('../../assets/img/potounitdua.png')} />
</View>

<View  style={{flexDirection:'row', padding:10, paddingLeft:130, bottom:20}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:30}} >Unit 2 :</Text>
</View>

<View  style={{flexDirection:'row', padding:10,}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:25, paddingLeft:60, bottom:40}} >What is The Recipe?</Text>
</View>

<View style={{flexDirection:'row', padding:10, paddingLeft:80, bottom:0}} >
