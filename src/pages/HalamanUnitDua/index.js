...
<View style={{padding:10,bottom:60, margin:20}} >
    <TouchableOpacity   onPress={()=>navigation.navigate('KelompokTaksDua')}  style={{padding:10, backgroundColor:colors.primary,  borderRadius:10,}} >
