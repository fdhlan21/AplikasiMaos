...
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <View style={{flexDirection:'row', padding:10,  paddingLeft:85}}>
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white}} >Account</Text>
  </View>
</View>
<ScrollView>
...
<View style={{flexDirection:'row', padding:10, paddingLeft:70,top:5 }} >
    <TouchableOpacity  onPress={() => setModal(true)}   style={{padding:10, backgroundColor:colors.primary, paddingHorizontal:80, borderRadius:10,}} >
        <Text style={{color:colors.white, fontFamily:'Alata-Regular', fontSize:15}}>Simpan</Text>
    </TouchableOpacity>
</View>
