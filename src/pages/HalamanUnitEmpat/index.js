...
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white}} >Unit 4</Text>
  </View>
</View>
<ScrollView>
 
<View   style={{ flexDirection:'row', padding:10,  paddingLeft:20, bottom:5}}>
    <Image style={{width:321, height:374}}     source={require('../../assets/img/potounitempat.png')} />
</View>

<View  style={{flexDirection:'row', padding:10, paddingLeft:130, bottom:20}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:30}} >Unit 4 :</Text>
</View>

<View  style={{flexDirection:'row', padding:10,}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:25, paddingLeft:50, bottom:40}} >The More You Read,</Text>
</View>
<View  style={{flexDirection:'row', padding:10,}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:25, paddingLeft:55, bottom:60}} >the More You Know</Text>
</View>

<View style={{flexDirection:'row', padding:10, paddingLeft:80, bottom:45}} >
