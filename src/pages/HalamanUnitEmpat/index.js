...
<View  style={{padding:10,}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:25,bottom:40, textAlign:'center'}} >The More You Read,</Text>
</View>
<View  style={{padding:10,}} >
    <Text  style={{fontFamily:'Alata-Regular', fontSize:25,bottom:60, textAlign:'center'}} >the More You Know</Text>
</View>
