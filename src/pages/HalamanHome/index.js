...
<TouchableOpacity    onPress={()=>navigation.navigate('HalamanTeacher')}  style={{padding:10, backgroundColor:colors.white,borderRadius:10, width:138, height:138, alignItems:'center'}} >
</TouchableOpacity>
</View>
