...
<View   style={{flexDirection:'row', padding:10,  }} >
  ...
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white}} > Result  Taks 2</Text>
  </View>
</View>
<ScrollView>
...
<View style={{flexDirection:'row', padding:10, paddingLeft:80, top:5 }} >
    <TouchableOpacity onPress={()=>navigation.navigate('HalamanTaks3')} style={{padding:10, backgroundColor:colors.primary, paddingHorizontal:80, borderRadius:10,}} >
