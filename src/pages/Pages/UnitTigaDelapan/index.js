...
<TouchableOpacity  style={{}}    onPress={()=>navigation.navigate('HalamanUnitTiga')} ><Image   style={{width:15, height:15,}} source={require('../../../assets/img/x.png')} /></TouchableOpacity>
</View>
...
export default KelompokTaksTigaDelapan;